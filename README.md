...
<div style="display:flex;">
 <div style="display:flex; flex-direction:column; align-itmes:center; border-radius: 10px;
  ...
  transition: all 100ms ease-in-out;">
      <img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/redux/redux-original.svg" alt="redux" width="40" height="40" style="  
  height: 70px;
  margin-bottom: 5px;
  object-fit: contain;"/> 
 </div>
